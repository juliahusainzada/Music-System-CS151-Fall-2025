...
public class Artist extends People {
    ...
    public Artist(String personId, String displayName, String phoneNumber, String stageName) {
        super(personId, displayName, phoneNumber);
    ...
    public void publishSong(Library library, String title, int durationSec, String album, String genre) {
        ...
        Song song = new Song(itemId, title, durationSec, personId, album, genre);
